...
//        }
    ...
    void feedbackPageTest() {
        ...
        element.click();
        List<WebElement> list  = driver.findElements(By.xpath("/html/body/div[2]/div/div[2]/div[2]/div/div[2]/div/h1"));
        driver.navigate().back();
        assertEquals(1, list.size());
...
//    @Test
//    void dillersPageTest() {
//        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated
//                (By.xpath("/html/body/div[2]/div/header/div/div[2]/div[2]/div[1]/div/a")));
//        WebElement element = driver.findElement(By.xpath("/html/body/div[2]/header/div/nav/ul[2]/li[2]/a"));
//        element.click();
//        List<WebElement> list  = driver.findElements(By.xpath("/html/body/div[2]/div/div/article/div/div/div/div[1]"));
//        driver.navigate().back();
//        assertEquals(1, list.size());
//    }
